public class Grafo {
	...
	/**
	 * Atributo para Matriz.
	 */
	private Integer[][] matriz;
	
	/**
	 * Construtor padr�o de um grafo.
	 * @param qtdVertices
	 * 		  Quantidade de vertice do grafo.	
	 * @throws Exception
	 * 		   Exce��o a ser lan�ada se n�mero de vertices for menor do que zero. 
	 */
	public Grafo(int qtdVertices) throws Exception {
		
		// Testa a quantidade de vertice.
		if (qtdVertices < 0) {
			throw new Exception("N�mero de vertices n�o pode ser menor do que zero.");
		}
	...
	/**
	 * M�todo respons�vel por criar a matriz.
	 */
	...
	public void imprimirMatriz() throws Exception {
		if (matriz == null) {
			...
			throw new Exception("Matriz n�o inicializada");
		}
		else {
			for(int l = 0 ; l < NUMERO_VERTICES ; l++){ 
	...
	/**
	 * M�todo respons�vel por inserir uma aresta.
	 * @param A
	 * @param B
	 * @param peso
	 * @throws Exception 
